...
/** * ERP Systems Service Page
 * Exact replica of BusinessAutomation & CustomCRM structure.
 */

// ইমেজ ইমপোর্টসমূহ (পাথ তোর প্রজেক্ট অনুযায়ী সেট করা)
...
const ERPSystems = () => {
    ...
    const expertiseData = [
        { 
            ...
            desc: "Optimize your company's resources with intelligent planning and allocation modules for maximum output.", 
            img: researchIcon 
        },
        { 
            id: "02", 
            title: "Supply Chain", 
            desc: "End-to-end visibility of your supply chain, from raw material procurement to final product delivery.", 
            img: uxIcon 
        },
        { 
            id: "03", 
            title: "Financial Core", 
            desc: "Centralized accounting, budgeting, and financial reporting with real-time accuracy and audit trails.", 
            img: webIcon 
        },
        { 
            id: "04", 
            title: "Data Analytics", 
            desc: "Advanced business intelligence tools to make data-driven decisions at every enterprise level.", 
            img: auditIcon 
        }
    ];
    ...
    const featureData = [
        {
            title: ["Unify Your Business", "In One Single Truth"],
            desc: "Stop working in silos. Our custom ERP solutions act as a single source of truth for your entire organization. By integrating departments like HR, Finance, and Operations into one centralized system, you eliminate data duplication and ensure everyone is working with the most up-to-date information.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["Scalable Architecture for", "Enterprise Growth"],
            desc: "As your organization expands, your ERP must keep up. We build modular ERP systems that allow you to add new functionalities—like international currency support or multi-warehouse management—without disrupting your core business operations.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Automated Reporting", "and Compliance"],
            desc: 'Generate complex tax reports, audit trails, and compliance documents with a single click. Our ERP systems are designed to handle local and international regulations, ensuring your business stays compliant while saving hundreds of manual hours.',
            img: businessImg,
            reverse: false,
        },
        {
            title: ["Real-Time Inventory", "and Asset Tracking"],
            desc: "Get 100% accuracy on your stock levels across multiple locations. Our integrated inventory modules use smart algorithms to predict stock-outs and automate purchase orders, ensuring your operations never hit a bottleneck.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Enterprise Audit", description: "Analyzing your current business workflows and department requirements deeply.", image: discoveryImg },
        { title: "System Blueprint", description: "Designing the ERP architecture and multi-department data integration strategy.", image: designImg },
        { title: "Implementation", description: "Custom development and phase-wise deployment of modular ERP components.", image: iterationImg },
        { title: "Optimization", description: "Post-launch tuning and performance scaling based on real-world user feedback.", image: handoffImg }
    ];
    ...
    const industryData = [
        { title: "Manufacturing", desc: "Manage shop floors, BOMs, and production cycles with precision.", img: img1 },
        { title: "Wholesale & Dist.", desc: "Automate large-scale orders and multi-warehouse logistics.", img: img2 },
        { title: "Healthcare Groups", desc: "Centralize patient records, pharmacy stock, and billing systems.", img: img3 },
        { title: "Construction", desc: "Project costing, resource management, and site tracking modules.", img: img4 },
        { title: "Apparel & Fashion", desc: "Manage seasonal inventories, SKUs, and supply chain demands.", img: img5 },
        { title: "Non-Profit", desc: "Track donations, grants, and multi-program resource allocation.", img: img6 },
        { title: "Energy & Utilities", desc: "Asset management and maintenance scheduling for large infra.", img: img7 },
        { title: "Agriculture", desc: "Farm-to-market tracking and production management systems.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-tight">
                                Enterprise ERP <br/>Solutions
                            </h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                Streamline your entire organization with a custom-built ERP. From finance to supply chain, integrate every department into one powerful platform.
                            </p>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">ERP <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Drive efficiency across all business functions with fully integrated modules.</p>
                    </div>
                        ...
                        {featureData.map((item, index) => (
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                <div className="w-full md:w-1/2 text-left">
                                    ...
                                    <p className="text-white text-[16px] md:text-[17px] leading-relaxed font-light max-w-[580px]">{item.desc}</p>
                                </div>
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="ERP Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Our ERP Deployment Roadmap</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">From initial system audit to multi-department scaling, we ensure a smooth enterprise transition.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Integrated Systems for Unmatched Productivity</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">We deliver bank-grade secure ERP solutions tailored to solve complex resource management bottlenecks.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="ERP Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        ...
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Custom ERP architectures optimized for large-scale operations across global sectors.</p>
                    </div>
