...
const UiUxDesign = () => {
    ...
    const expertiseData = [
        { id: "01", title: "User Research", desc: "Creating purposeful designs through user data and behavioral insights.", img: researchIcon },
        { id: "02", title: "UI/UX Design", desc: "Elevate your brand with clean, pixel-perfect UI/UX designed for maximum engagement.", img: uxIcon },
        { id: "03", title: "Wireframing & Prototyping", desc: "Crafting pixel-perfect, aesthetic interfaces that align with your brand identity.", img: webIcon },
        { id: "04", title: "Design Audit", desc: "Streamlining user experiences and driving conversions through usability audits.", img: auditIcon }
    ];

    const featureData = [
        {
            title: ["Putting Your Users at the", "Heart of Every Pixel"],
            desc: "Great design starts with deep understanding, not just visual aesthetics. We believe that to build a successful product, we must first step into the shoes of your users to understand their daily challenges, motivations, and pain points. Our approach involves diving deep into behavioral psychology to create intuitive interfaces that feel like a natural extension of the user’s thought process. By prioritizing human needs over technical complexity, we reduce cognitive load and eliminate friction, ensuring that every interaction within your digital product is meaningful, effortless, and creates a lasting emotional connection.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["Breaking Barriers for", "Universal Access"],
            desc: "In today’s digital landscape, accessibility is not a luxury or an afterthought—it is a fundamental standard of high-quality design. We practice radical inclusivity, which means we build every interface with the goal of being usable by everyone, regardless of their physical, visual, or cognitive abilities. By strictly adhering to global WCAG standards and focusing on high-contrast visuals, screen-reader compatibility, and adaptive navigation, we ensure your brand remains ethical and accessible. This commitment to inclusivity doesn't just fulfill legal requirements; it broadens your market reach.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Where Aesthetics Meet", "Business Results"],
            desc: 'We believe that a beautiful design is only truly successful if it drives measurable business growth and high ROI. Our philosophy merges aesthetic excellence with strategic conversion tactics, using data-backed design patterns to guide users toward your primary goals. We meticulously analyze visual hierarchy, button placements, and information architecture to turn casual visitors into loyal customers. By focusing on the "science of persuasion" and retention-based UX, we ensure that your product doesn\'t just look professional, but acts as a powerful engine for sales and long-term scalability.',
            img: businessImg,
            reverse: false,
        },
        {
            title: ["Built to Grow and", "Designed to Last"],
            desc: "A digital product is a living entity that must evolve alongside your business and emerging technologies. Our design philosophy centers on building sustainable ecosystems rather than isolated pages. We create comprehensive Atomic Design Systems and modular UI kits that allow your product to scale seamlessly without losing visual or functional consistency. By providing clean, developer-friendly handoffs and an adaptive architecture, we ensure that your platform remains modern and high-performing for years to come. This approach saves time and resources while maintaining a world-class identity.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Discovery", description: "We analyze your goals to build a strategic technical roadmap.", image: discoveryImg },
        { title: "Design", description: "Crafting intuitive interfaces that simplify the user experience.", image: designImg },
        { title: "Iteration", description: "Refining designs through feedback to ensure peak performance.", image: iterationImg },
        { title: "Handoff", description: "Delivering developer-ready assets for a seamless launch.", image: handoffImg }
    ];

    const points = ["Insight-Led Innovation", "Value-First Pricing", "Human-First Experience", "Tailored Excellence", "Pixel-Perfect Craftsmanship"];

    const industryData = [
        { title: "FinTech", desc: "Designing secure and intuitive digital banking and payment experiences.", img: img1 },
        { title: "E-commerce", desc: "Creating seamless shopping journeys that drive sales and loyalty.", img: img2 },
        { title: "HealthTech", desc: "Human-centric designs for healthcare apps and medical platforms.", img: img3 },
        { title: "EdTech", desc: "Enhancing learning through interactive and engaging educational tools.", img: img4 },
        { title: "SaaS", desc: "Simplifying complex workflows with powerful, user-friendly dashboards.", img: img5 },
        { title: "Real Estate", desc: "Building modern platforms for effortless property discovery and sales.", img: img6 },
        { title: "Travel & Hospitality", desc: "Crafting delightful booking and exploration experiences for travelers.", img: img7 },
        { title: "Food & Delivery", desc: "Optimizing speed and convenience for food and logistics services.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-tight">UI/UX Design</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                Craft immersive digital experiences with our UI/UX expertise. We design intuitive, beautiful interfaces that captivate users and accelerate your growth.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="UI/UX Visuals" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Our UI/UX <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Comprehensive design solutions tailored to your business goals and your users' needs.</p>
                    </div>
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">My UI/UX Design Process</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">We build user-centered designs through deep research, strategic wireframing, and rigorous testing to drive business growth.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">We Design What Your Audience Needs</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">At Campaignsquat, we deliver high-impact UI/UX solutions tailored to solve real problems and turn your complex ideas into seamless digital experiences.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="UI UX Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        ...
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Tailored design solutions across diverse sectors to solve complex problems.</p>
                    </div>
