...
const CustomWebsites = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Tailored Architecture", desc: "Building from scratch with custom logic that fits your specific business workflow perfectly.", img: architectureIcon },
        { id: "02", title: "Exclusive UI/UX", desc: "Unique visual interfaces designed specifically for your brand, no pre-made templates used.", img: blueprintIcon },
        { id: "03", title: "Scalable Logic", desc: "Custom backend development that handles complex data and evolves with your enterprise growth.", img: userFlowIcon },
        { id: "04", title: "API Integration", desc: "Seamlessly connecting your custom web platform with any third-party tools or internal systems.", img: testingIcon }
    ];

    const featureData = [
        {
            title: ["Zero Template", "Total Freedom"],
            desc: "Custom website development is about breaking free from the limitations of off-the-shelf themes. We build every component from the ground up, giving you 100% control over the functionality and aesthetics. Whether it's a unique booking system or a complex data visualization dashboard, we bring your specific vision to life without compromises.",
            img: architectureImg,
            reverse: false,
        },
        {
            title: ["High-Security", "Core Development"],
            desc: "Standard platforms are often targets for mass attacks. By building a custom solution, we reduce the footprint for potential vulnerabilities. We implement enterprise-grade security protocols tailored to your specific data handling needs, ensuring that your intellectual property and user data remain impenetrable.",
            img: userJourneyImg,
            reverse: true,
        },
        {
            title: ["Performance Without", "Bloatware"],
            desc: "Most CMS platforms come with unnecessary code that slows down your site. Our custom-built websites are lean, mean, and fast. We only include the features you need, resulting in lightning-fast response times and a significantly better user experience that keeps your visitors engaged.",
            img: lowFidImg,
            reverse: false,
        },
        {
            title: ["Adaptive Logic for", "Complex Business"],
            desc: "Your business is unique, and your website should be too. We specialize in developing custom logic that automates your specific business processes. From complex pricing calculators to custom CRM integrations, we build the tools that make your daily operations more efficient and profitable.",
            img: validationImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Consultation", description: "In-depth analysis of your unique business requirements and goals.", image: discoveryImg },
        { title: "Blueprint", description: "Designing the custom system architecture and user experience flow.", image: designImg },
        { title: "Engineering", description: "Hand-coding the frontend and backend with precision and care.", image: iterationImg },
        { title: "Deployment", description: "Launching your exclusive platform with full support and training.", image: handoffImg }
    ];

    const points = ["No Template Limitations", "Optimized Database Design", "Proprietary Feature Builds", "Enhanced Cyber Security", "Direct Technical Support"];

    const industryData = [
        { title: "Bespoke Portals", desc: "Custom internal portals for large-scale employee or client management.", img: img1 },
        { title: "Unique Dashboards", desc: "Visualizing complex data sets in an easy-to-use custom interface.", img: img2 },
        { title: "Legal Tech", desc: "Secure document handling systems for high-stakes legal environments.", img: img3 },
        { title: "Asset Management", desc: "Custom tracking and management tools for physical or digital assets.", img: img4 },
        { title: "Energy Sector", desc: "Real-time monitoring sites for industrial and energy output data.", img: img5 },
        { title: "Gov-Tech", desc: "Highly secure and accessible platforms for public service delivery.", img: img6 },
        { title: "Music & Media", desc: "Custom streaming or library management for media-heavy brands.", img: img7 },
        { title: "HR Systems", desc: "Tailored recruitment and performance tracking web applications.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-tight">Custom Websites</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                We engineer bespoke digital solutions from the ground up, designed to solve your specific business challenges without compromise.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="Custom Web Visuals" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Custom <span>Focus</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Why settle for ordinary when you can have a website built exactly for you?</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="Custom Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Our Custom Workflow</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">Precision engineering for results that template-based sites simply can't achieve.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Built for Your Ambition</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">We specialize in taking complex ideas and turning them into seamless, high-performance web applications that give you a competitive edge.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="Custom Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Unlimited Industry Potential</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Custom platforms tailored to the specific logic of any sector.</p>
                    </div>
