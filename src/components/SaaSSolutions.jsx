...
/**
 * SaaS Product Development Page
 * Premium Dark UI with Golden Highlights
 */
...
const SaaSSolutions = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Multi-Tenancy", desc: "Robust architecture that allows multiple organizations to share a single application securely.", img: researchIcon },
        { id: "02", title: "Subscription Engine", desc: "Automated recurring billing, tier-based pricing, and integrated payment gateways.", img: uxIcon },
        { id: "03", title: "Cloud Scalability", desc: "Auto-scaling infrastructure designed to handle thousands of concurrent users globally.", img: webIcon },
        { id: "04", title: "API-First Design", desc: "Building comprehensive APIs to allow users to integrate your SaaS with other tools.", img: auditIcon }
    ];

    const featureData = [
        {
            title: ["Build Once, Scale", "Everywhere Globally"],
            desc: "The power of SaaS lies in its reach. We build cloud-native applications that are accessible from any device, anywhere in the world. Our engineering focus is on creating high-performance, multi-tenant architectures that ensure each customer has a private, secure experience.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["Advanced Subscription and", "User Management"],
            desc: "Managing thousands of subscribers requires precision. We integrate advanced billing engines like Stripe or Chargebee, allowing you to offer free trials, monthly/yearly plans, and custom enterprise pricing with ease.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Data Security and", "Privacy Compliance"],
            desc: 'In the SaaS world, trust is everything. We implement SOC2-level security standards, end-to-end encryption, and GDPR/CCPA compliance features to protect user data with advanced security protocols.',
            img: businessImg,
            reverse: false,
        },
        {
            title: ["Comprehensive Analytics", "Dashboard for Users"],
            desc: "Add value to your SaaS by providing users with deep insights. We build beautiful, interactive data visualization dashboards that help your customers understand their usage patterns and ROI.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "MVP Strategy", description: "Defining the core features needed to launch and test your SaaS idea.", image: discoveryImg },
        { title: "Cloud Arch", description: "Designing a scalable AWS/Azure infrastructure for global traffic.", image: designImg },
        { title: "Agile Dev", description: "Continuous integration and rapid feature deployment cycles.", image: iterationImg },
        { title: "Launch & Scale", description: "Product launch followed by performance monitoring and scaling.", image: handoffImg }
    ];

    const points = ["Zero-Downtime Updates", "Microservices Architecture", "White-Label Options", "Self-Service Onboarding", "Real-time Monitoring"];

    const industryData = [
        { title: "MarTech", desc: "SaaS platforms for marketing automation and social media management.", img: img1 },
        { title: "EdTech", desc: "Learning management systems for schools and professional courses.", img: img2 },
        { title: "FinTech", desc: "Cloud-based accounting, budgeting, and investment platforms.", img: img3 },
        { title: "HealthTech", desc: "Telemedicine and patient portal SaaS for healthcare providers.", img: img4 },
        { title: "Project Management", desc: "Collaboration tools for remote teams and agile workflows.", img: img5 },
        { title: "PropTech", desc: "SaaS for real estate management and virtual property tours.", img: img6 },
        { title: "LegalTech", desc: "Cloud-based case management and automated legal drafting.", img: img7 },
        { title: "HRTech", desc: "Modern recruitment and talent management SaaS solutions.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-[1.2] md:leading-[1.4] lg:leading-[1.4]">SaaS Product <br/>Development</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal opacity-80">
                                Launch your software as a service. We help you build, scale, and manage profitable SaaS products with cloud-native technology.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="SaaS Solutions" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">SaaS <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium opacity-80">Engineer products that grow from 1 to 1 million users seamlessly.</p>
                    </div>
                        ...
                        {expertiseData.map((item, index) => (
                            <div key={index} className="group relative bg-[#02050A] border border-white/10 p-10 rounded-[5px] transition-all duration-500 hover:border-[#F7A400]/40 flex flex-col items-start text-left overflow-hidden hover:-translate-y-2">
                                ...
                                <div className="mb-8 w-16 h-16 flex items-center justify-start relative z-10">
                                    <img src={item.img} alt={item.title} className="w-full h-full object-contain transition-transform duration-500 group-hover:scale-110 origin-left invert" style={{ filter: 'invert(71%) sepia(85%) saturate(945%) hue-rotate(354deg) brightness(102%) contrast(101%)' }} />
                                </div>
                        ...
                        {featureData.map((item, index) => (
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                <div className="w-full md:w-1/2">
                                    ...
                                    <p className="text-white text-[16px] md:text-[17px] leading-relaxed font-light text-left max-w-[580px] opacity-80">{item.desc}</p>
                                </div>
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="SaaS Solution Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">SaaS Development Journey</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light opacity-80">Cloud-native development cycles designed for high-speed innovation.</p>
                    </div>
                        ...
                        {processSteps.map((step, index) => (
                            <div key={index} className="flex flex-col items-center text-center group cursor-pointer">
                                ...
                                <div className="w-full flex flex-col items-center">
                                    ...
                                    <p className="text-white text-[15px] md:text-[16px] leading-relaxed font-light max-w-[280px] opacity-70">{step.description}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Cloud-Native Architectures for Global Success</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px] opacity-80">We engineer SaaS products that are resilient, easy to update, and ready to handle global demand without interruption.</p>
                            <div className="flex flex-col gap-6 md:gap-7 mb-12">
                                {points.map((point, index) => (
                                    <div key={index} className="flex items-center gap-5 group">
                                        <div className="w-8 h-8 md:w-9 md:h-9 shrink-0 rounded-full border-2 border-[#F7A400] flex items-center justify-center transition-all duration-300 group-hover:bg-[#F7A400]">
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="SaaS Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl transition-all duration-700 hover:rotate-1" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        ...
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light opacity-80">Specialized cloud products tailored for specific market segments.</p>
                    </div>
