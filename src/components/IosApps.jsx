...
const IosApps = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Native iOS Dev", desc: "Building premium applications using Swift and SwiftUI for high-end performance on Apple devices.", img: researchIcon },
        { id: "02", title: "Apple Store Quality", desc: "Ensuring your app meets Apple’s strict Human Interface Guidelines for a seamless App Store launch.", img: uxIcon },
        { id: "03", title: "iPadOS & WatchOS", desc: "Expanding your reach with apps optimized for iPad, Apple Watch, and the entire Apple ecosystem.", img: webIcon },
        { id: "04", title: "Performance Tuning", desc: "Optimizing code for maximum speed, fluid animations, and efficient battery usage on iPhones.", img: auditIcon }
    ];

    const featureData = [
        {
            title: ["The Gold Standard of", "iOS Performance"],
            desc: "Apple users expect nothing less than perfection. We build iOS applications that are incredibly fast, fluid, and responsive. By leveraging the power of native technologies like Swift, we ensure that every interaction—from a simple swipe to complex data processing—feels instantaneous and natural, providing the high-quality experience that iPhone users demand.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["Adhering to Apple’s", "Human Interface Guidelines"],
            desc: "Great iOS apps follow a specific design language. We meticulously implement Apple’s Human Interface Guidelines (HIG) to ensure your app feels like a part of the OS. From SF Symbols to intuitive navigation patterns, we focus on clarity, deference, and depth, making sure your application is both beautiful and easy to use for millions of Apple loyalists.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Uncompromising Privacy", "and Data Security"],
            desc: "Security is the core of iOS. We implement industry-leading security features including App Tracking Transparency, biometric authentication (FaceID/TouchID), and secure Keychain storage. Our development process ensures your app is fully compliant with Apple’s latest privacy standards, giving your users peace of mind and protecting your brand reputation.",
            img: businessImg,
            reverse: false,
        },
        {
            title: ["Seamless Integration", "with iCloud & Apple Pay"],
            desc: "We bring the power of the Apple ecosystem to your fingertips. Whether it's seamless data syncing across devices via iCloud, one-tap payments with Apple Pay, or integration with Apple HealthKit, we ensure your app works perfectly with the services your users already love and use every single day.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Strategy", description: "Planning features and architecture specifically for the iOS user base.", image: discoveryImg },
        { title: "iOS Design", description: "Crafting a premium UI that aligns with Apple's aesthetic standards.", image: designImg },
        { title: "Swift Coding", description: "Writing clean, robust code using modern Swift and SwiftUI frameworks.", image: iterationImg },
        { title: "App Store Launch", description: "Navigating Apple’s review process for a successful store publication.", image: handoffImg }
    ];
    ...
    const industryData = [
        { title: "FinTech", desc: "Secure banking apps with Apple Pay and high-end encryption.", img: img1 },
        { title: "E-commerce", desc: "Premium shopping experiences optimized for the mobile shopper.", img: img2 },
        { title: "Health & Fitness", desc: "Health tracking apps integrated with Apple Health and WatchOS.", img: img3 },
        { title: "Education", desc: "Interactive learning platforms with high-quality media support.", img: img4 },
        { title: "SaaS", desc: "Powerful business dashboards with native iOS performance.", img: img5 },
        { title: "Real Estate", desc: "Visual property discovery with ARKit for immersive tours.", img: img6 },
        { title: "Hospitality", desc: "Delightful travel and booking apps for a global audience.", img: img7 },
        { title: "Lifestyle", desc: "Custom apps that integrate seamlessly into the user’s daily life.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-[1.2] md:leading-[1.4] lg:leading-[1.4]">iOS App Development</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                Build premium experiences for the world’s most loyal users. We create sophisticated, high-performance iOS apps that define quality and innovation.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="iOS Development" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Our iOS <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Delivering state-of-the-art iOS solutions that set new standards in the App Store.</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="iOS Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Our iOS Development Process</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">We combine technical precision with Apple's aesthetic standards to build world-class applications.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Elevate Your Brand with a Premium iOS App</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">At Campaignsquat, we specialize in creating iOS apps that don't just work—they provide a superior experience that reflects your brand’s excellence.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="iOS Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Vertical iOS Solutions</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Premium iOS applications custom-built to solve complex industry-specific challenges.</p>
                    </div>
