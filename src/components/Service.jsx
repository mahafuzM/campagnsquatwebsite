...
import img1 from '../assets/images/mren (1).png';
import img2 from '../assets/images/rfom (1).png';
import imgMobile from '../assets/images/ph.png';
    ...
    <section className="w-full bg-[#02050A] py-16 md:py-24 font-poppins overflow-hidden">
      <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
        ...
        <div className="flex flex-col items-center text-center mb-10 md:mb-16">
          <h2 className="text-white text-[28px] md:text-[45px] font-bold">
            Service we provides
          </h2>
          <p className="text-white text-[16px] md:text-[20px] mt-4 opacity-90">
                  ...
                  <div className="group mx-auto flex flex-col items-center bg-white/5 border border-white/10 overflow-hidden w-full h-[480px] md:h-[520px] transition-all duration-300 hover:border-[#F7A400]/40 hover:bg-white/[0.08] hover:-translate-y-2">
                    ...
                    <div className="flex flex-col items-center justify-between flex-grow text-center w-full">
                      <div className="px-6 pt-6">
                        <h3 className="text-white text-[18px] md:text-[22px] font-bold mb-3 uppercase">
                          {item.title}
                        </h3>
                      ...
                      <Link to={item.link} className="w-full">
                        <button className="w-full bg-[#F7A400] text-white text-xl font-bold py-4 border-2 border-[#F7A400] hover:bg-transparent transition-all">
                          {item.btnText}
                        </button>
                      </Link>
                    </div>
        ...
        <div className="flex justify-center mt-12 md:mt-16">
          <Link to="/service">
            <button className="px-10 py-3.5 bg-[#F7A400] text-white text-xl rounded-[5px] font-semibold border-2 border-[#F7A400] hover:bg-transparent transition-all">
              Explore All Service
            </button>
          </Link>
        </div>
