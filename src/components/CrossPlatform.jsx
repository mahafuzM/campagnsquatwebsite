...
// ইমেজ ইমপোর্টসমূহ (আগের মতোই থাকবে)
...
const CrossPlatform = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Flutter Development", desc: "Creating high-fidelity, high-performance apps for mobile, web, and desktop from a single codebase.", img: researchIcon },
        { id: "02", title: "React Native", desc: "Building native-like experiences using JavaScript and React to speed up the development cycle.", img: uxIcon },
        { id: "03", title: "Code Reusability", desc: "Optimizing development costs by sharing up to 90% of the code between Android and iOS platforms.", img: webIcon },
        { id: "04", title: "Hybrid Solutions", desc: "Modern hybrid app development that combines web flexibility with native performance capabilities.", img: auditIcon }
    ];

    const featureData = [
        {
            title: ["One Codebase,", "Infinite Possibilities"],
            desc: "Why build twice when you can build once? Our cross-platform solutions allow you to reach both Android and iOS audiences simultaneously. By using a single codebase, we ensure that your business logic, features, and UI remain consistent across all devices, significantly reducing development time and maintenance costs without sacrificing the premium feel of a native app.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["Native-Like Speed", "and Responsiveness"],
            desc: "Gone are the days when hybrid apps were slow. With modern frameworks like Flutter and React Native, we deliver applications that perform at near-native speeds. We optimize every component to ensure smooth animations, quick load times, and a seamless user experience that feels completely at home on any operating system.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Faster Time-to-Market", "for Your Business"],
            desc: "In the fast-paced digital world, speed is everything. Cross-platform development allows us to build and deploy your app much faster than traditional native methods. This means you can launch your MVP (Minimum Viable Product) earlier, gather user feedback sooner, and stay ahead of your competition while keeping your budget under control.",
            img: businessImg,
            reverse: false,
        },
        {
            title: ["Consistent Brand", "Experience Everywhere"],
            desc: "Maintaining brand identity can be tough when developing for different platforms. Our cross-platform approach ensures that your brand’s colors, typography, and interactive elements look and behave exactly the same on an iPhone as they do on a Samsung Galaxy. This consistency builds trust and provides a professional image to your entire user base.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Strategy", description: "Identifying the right cross-platform framework for your business needs.", image: discoveryImg },
        { title: "UI Design", description: "Designing a unified interface that works beautifully on all screen sizes.", image: designImg },
        { title: "Unified Dev", description: "Writing scalable code that targets both Android and iOS platforms.", image: iterationImg },
        { title: "Global Launch", description: "Deploying your application to both major app stores simultaneously.", image: handoffImg }
    ];

    const points = ["Flutter & React Native Pros", "Cost-Effective Solutions", "Unified UI/UX Design", "Simplified Maintenance", "Faster Feature Updates"];

    const industryData = [
        { title: "Startups", desc: "Quickly launching MVPs on both platforms to test market ideas.", img: img1 },
        { title: "E-commerce", desc: "Unified shopping apps that reach the widest possible audience.", img: img2 },
        { title: "Social Media", desc: "Engaging communities with smooth, cross-platform interactions.", img: img3 },
        { title: "Education", desc: "Access to learning materials on any device, anywhere in the world.", img: img4 },
        { title: "Business Tools", desc: "Internal employee apps that work on everyone's personal phone.", img: img5 },
        { title: "Real Estate", desc: "Broad property reach with consistent features for all users.", img: img6 },
        { title: "Travel", desc: "Convenient booking tools available on both iOS and Android.", img: img7 },
        { title: "Entertainment", desc: "Streaming and media apps that provide a seamless experience.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-[1.2] md:leading-[1.4] lg:leading-[1.4]">Cross-Platform Development</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                Maximize your reach while minimizing costs. We build powerful apps that work flawlessly on both Android and iOS using a single, high-quality codebase.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="Cross Platform Development" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Cross-Platform <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Smart development solutions that bridge the gap between platforms with modern technology.</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="Cross Platform Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Cross-Platform Dev Cycle</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">We use efficient workflows to build and sync your application across multiple environments seamlessly.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">The Smartest Way to Launch Your Mobile App</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">Don't limit your audience. With Campaignsquat’s cross-platform expertise, you get a high-performing app that works for everyone, everywhere.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="Cross Platform Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Cross-Platform Industry Impact</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Versatile solutions designed to provide equal value to all users, regardless of their device choice.</p>
                    </div>
