...
const PersonalBranding = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Visual Storytelling", desc: "Crafting a unique aesthetic that communicates your personal journey and expertise visually.", img: architectureIcon },
        { id: "02", title: "Portfolio Curation", desc: "Highlighting your best work with high-impact layouts designed to impress recruiters and clients.", img: blueprintIcon },
        { id: "03", title: "Authority SEO", desc: "Optimizing your name and expertise for search engines to ensure you're found first in your niche.", img: userFlowIcon },
        { id: "04", title: "Social Integration", desc: "Seamlessly connecting your personal site with LinkedIn, Twitter, and other professional platforms.", img: testingIcon }
    ];

    const featureData = [
        {
            title: ["Turning Your Name", "Into a Global Brand"],
            desc: "In the digital age, your personal website is your permanent resume. We build platforms that elevate your individual authority, allowing you to control your narrative. Whether you are a CEO, a creative, or a consultant, we ensure your site reflects the premium quality of your personal expertise and professional value.",
            img: architectureImg,
            reverse: false,
        },
        {
            title: ["Interactive Portfolio", "Showcasing"],
            desc: "Don't just list your work; tell the story behind it. We design interactive project galleries and case study layouts that guide visitors through your problem-solving process. This depth of presentation builds higher trust and justifies premium pricing for your services.",
            img: userJourneyImg,
            reverse: true,
        },
        {
            title: ["Thought Leadership", "Engineered"],
            desc: "Content is the heart of personal branding. We build custom blog systems and newsletter integrations that make it easy for you to share your insights. By positioning you as a thought leader, we help you attract high-ticket opportunities and speaking engagements effortlessly.",
            img: lowFidImg,
            reverse: false,
        },
        {
            title: ["Direct Booking &", "Consultation Flows"],
            desc: "Your website should be your 24/7 personal assistant. We integrate sophisticated scheduling tools and payment gateways, allowing visitors to book consultations or buy your digital products directly. We automate the 'business of you' so you can focus on your craft.",
            img: validationImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Personal Audit", description: "Defining your unique value proposition and target audience goals.", image: discoveryImg },
        { title: "Brand Identity", description: "Choosing the typography, colors, and tone that represent you.", image: designImg },
        { title: "Custom Build", description: "Developing a responsive, fast-loading site tailored to your personality.", image: iterationImg },
        { title: "Launch & Growth", description: "Deploying your brand and setting up analytics to track your influence.", image: handoffImg }
    ];

    const points = ["Unique Aesthetic Identity", "Mobile-Optimized Portfolio", "Expert-Level Blog Structure", "Lead-Capture For Opportunities", "Speed-Optimized User Experience"];

    const industryData = [
        { title: "Executive Portfolios", desc: "Professional landing pages for C-suite leaders and directors.", img: img1 },
        { title: "Creative Showcases", desc: "Dynamic galleries for photographers, designers, and artists.", img: img2 },
        { title: "Consultant Hubs", desc: "Authority-building sites for independent business advisors.", img: img3 },
        { title: "Speaker Platforms", desc: "Showcasing reels and topics for professional keynote speakers.", img: img4 },
        { title: "Developer Profiles", desc: "Clean, code-focused portfolios highlighting technical stacks.", img: img5 },
        { title: "Content Creators", desc: "Home bases for YouTubers, podcasters, and influencers.", img: img6 },
        { title: "Author Websites", desc: "Elegant platforms for writers to promote books and insights.", img: img7 },
        { title: "Coach & Mentor", desc: "Coaching funnels with integrated booking and course sales.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-tight">Personal Branding</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                We design bespoke digital identities that position you as an authority and turn your expertise into a powerful personal brand.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="Personal Branding" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Own Your <span>Influence</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Bespoke design for individuals who want to lead their industry.</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="Personal Brand Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">The Journey to Authority</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">A focused workflow to build a professional home for your unique story.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Invest In Your Identity</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">We believe your name is your most valuable asset. Our mission is to provide you with a world-class digital platform that opens doors, builds connections, and enhances your professional life.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="Branding Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Influence Across Domains</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Custom platforms tailored for experts in every field.</p>
                    </div>
