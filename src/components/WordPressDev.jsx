...
const WordPressDev = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Custom Theme Dev", desc: "Building lightweight, high-performance themes from scratch without bulky page builders.", img: architectureIcon },
        { id: "02", title: "Plugin Engineering", desc: "Developing custom plugins to add specialized features while maintaining site speed.", img: blueprintIcon },
        { id: "03", title: "WooCommerce Setup", desc: "Crafting powerful e-commerce stores with customized checkout and product flows.", img: userFlowIcon },
        { id: "04", title: "WP Optimization", desc: "Deep performance tuning and security hardening for enterprise-level WordPress sites.", img: testingIcon }
    ];

    const featureData = [
        {
            title: ["Scalable CMS", "Architecture"],
            desc: "WordPress powers 40% of the web for a reason. We leverage its flexibility to build content management systems that are easy for your team to use but powerful enough to handle millions of visitors. Our approach avoids 'plugin bloat,' focusing instead on clean, custom code that ensures long-term stability.",
            img: architectureImg,
            reverse: false,
        },
        {
            title: ["Custom Gutenberg", "Block Development"],
            desc: "We empower your content creators with custom-designed Gutenberg blocks. No more struggling with restrictive templates. We build a set of proprietary blocks that match your brand perfectly, allowing you to build complex pages with a simple drag-and-drop experience.",
            img: userJourneyImg,
            reverse: true,
        },
        {
            title: ["Performance First", "Development"],
            desc: "WordPress sites are often criticized for being slow. We prove that wrong. By using modern development workflows, headless options, or custom-coded themes, we achieve lightning-fast load times and perfect Core Web Vitals scores that search engines love.",
            img: lowFidImg,
            reverse: false,
        },
        {
            title: ["Security & Managed", "Maintenance"],
            desc: "Our relationship doesn't end at launch. We implement multi-layer security protocols, including custom firewalls and regular vulnerability scanning. We ensure your WordPress installation, plugins, and server environment are always updated and optimized against threats.",
            img: validationImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Audit", description: "Reviewing your current site or requirements for a fresh WP installation.", image: discoveryImg },
        { title: "Architecture", description: "Planning custom post types, taxonomies, and user permission roles.", image: designImg },
        { title: "Dev & Test", description: "Custom coding themes and plugins in a staging environment.", image: iterationImg },
        { title: "Optimization", description: "Final speed tuning and security hardening before going live.", image: handoffImg }
    ];

    const points = ["Custom-Coded Themes (No Bloat)", "Advanced WooCommerce Logic", "SEO-Friendly Structure", "Secure Hosting Integration", "Post-Launch WP Support"];

    const industryData = [
        { title: "Corporate Sites", desc: "High-authority business sites built on a reliable WP foundation.", img: img1 },
        { title: "Woo-Stores", desc: "Tailored e-commerce experiences with complex product rules.", img: img2 },
        { title: "News & Media", desc: "High-traffic portals optimized for rapid content publishing.", img: img3 },
        { title: "Portfolio Sites", desc: "Visually stunning showcases for creative agencies and artists.", img: img4 },
        { title: "Non-Profit Hubs", desc: "Engagement-focused sites with integrated donation systems.", img: img5 },
        { title: "Learning LMS", desc: "Course management systems built using LearnDash or custom code.", img: img6 },
        { title: "Real Estate WP", desc: "IDX/MLS integrations with custom property search features.", img: img7 },
        { title: "Booking Portals", desc: "Custom reservation systems for salons, clinics, and hotels.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-tight  eading-[1.2] md:leading-[1.4] lg:leading-[1.4]">WordPress Development</h1>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="WordPress Dev" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">WP <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Modernizing the world's most popular CMS with expert engineering.</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="WordPress Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Our WordPress Roadmap</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">A specialized workflow for building robust, secure, and manageable WP sites.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Professional WP Engineering</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">We don't just 'install' WordPress; we engineer it. Our custom approach ensures your site is fast, impossible to hack, and extremely easy for you to manage.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="WordPress Excellence" className="w-full h-auto max-h-[700px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Proven WP Industry Experience</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Versatile WordPress solutions built for specialized business domains.</p>
                    </div>
