...
const FoodDelivery = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Live Order Tracking", desc: "Hyper-accurate GPS integration for real-time tracking of orders from kitchen to doorstep.", img: researchIcon },
        { id: "02", title: "Dynamic Menus", desc: "Intuitive interfaces for restaurants to update items, prices, and availability instantly.", img: uxIcon },
        { id: "03", title: "Smart Dispatch", desc: "AI-based logistics to assign the nearest delivery partner for lightning-fast service.", img: webIcon },
        { id: "04", title: "Secure Payments", desc: "Seamless integration with digital wallets and cards for a quick checkout experience.", img: auditIcon }
    ];

    const featureData = [
        {
            title: ["Interactive Dining", "Interfaces"],
            desc: "Visual appeal is key in food tech. We build stunning, high-performance interfaces that showcase food items with high-resolution imagery and easy-to-use filters. From dietary preferences to custom add-ons, we ensure the ordering process is as satisfying as the meal itself.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["Geofencing &", "Local Logistics"],
            desc: "Location intelligence is the backbone of food delivery. Our apps use advanced geofencing to show users the best nearby restaurants and estimate precise delivery times based on traffic and kitchen preparation status, ensuring high reliability.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Comprehensive", "Multi-App Ecosystem"],
            desc: "We don't just build one app; we build a complete ecosystem. This includes a user-friendly app for customers, a streamlined dashboard for restaurant owners, and a high-performance app for delivery partners to manage their routes and earnings.",
            img: businessImg,
            reverse: false,
        },
        {
            title: ["Engagement &", "Loyalty Features"],
            desc: "Keep users coming back with personalized rewards. We implement advanced coupon systems, loyalty points, and smart push notifications that trigger during meal times or based on previous ordering habits to boost retention rates.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Market Research", description: "Analyzing food trends and delivery patterns in your target region.", image: discoveryImg },
        { title: "UX Prototyping", description: "Designing a frictionless ordering flow for maximum conversion.", image: designImg },
        { title: "Agile Development", description: "Building robust APIs for real-time data sync and reliability.", image: iterationImg },
        { title: "Launch & Support", description: "Deploying to App Stores and providing 24/7 technical maintenance.", image: handoffImg }
    ];
    ...
    const industryData = [
        { title: "Cloud Kitchens", desc: "Optimized workflows for delivery-only restaurant models.", img: img1 },
        { title: "Grocery Delivery", desc: "Inventory-heavy apps with weight-based pricing logic.", img: img2 },
        { title: "Alcohol & Drinks", desc: "Age-verified delivery systems with specialized logistics.", img: img3 },
        { title: "Baking & Sweets", desc: "Pre-order management for cakes and customized items.", img: img4 },
        { title: "Organic & Fresh", desc: "Direct-from-farm marketplaces with freshness tracking.", img: img5 },
        { title: "Pet Food Delivery", desc: "Subscription-based ordering for pet nutrition and treats.", img: img6 },
        { title: "Meat & Seafood", desc: "Temperature-controlled logistics tracking and assurance.", img: img7 },
        { title: "Daily Meal Kits", desc: "Subscription models for healthy, home-cooked meal prep.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-[1.2] md:leading-[1.4] lg:leading-[1.4]">Food Delivery App Development</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                Connect hungry customers with their favorite flavors. We build high-performance, real-time food delivery platforms that scale with your growth.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="Food Delivery Tech" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Food Tech <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Powering the next generation of on-demand dining with scalable mobile architecture.</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="Food App Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Food App Roadmap</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">From culinary research to live logistics management, we handle the full development lifecycle.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Dominating the Food Market with Tech</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">Success in food delivery requires speed and reliability. Campaignsquat builds the infrastructure that keeps orders flowing and customers satisfied.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="Food Delivery Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Food & Beverage Verticals</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Customized logic for various food delivery models to ensure operational efficiency.</p>
                    </div>
