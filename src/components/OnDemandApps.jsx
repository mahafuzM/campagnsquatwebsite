...
const OnDemandApps = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Real-time Matching", desc: "Complex algorithms to connect users with the nearest service providers in milliseconds.", img: researchIcon },
        { id: "02", title: "Geolocation Services", desc: "Precision GPS tracking and route optimization for seamless service fulfillment.", img: uxIcon },
        { id: "03", title: "In-App Wallet", desc: "Secure digital wallets and automated payout systems for providers and partners.", img: webIcon },
        { id: "04", title: "Instant Messaging", desc: "Real-time chat and call masking to ensure safe communication within the platform.", img: auditIcon }
    ];

    const featureData = [
        {
            title: ["Instant Fulfillment", "at Your Fingertips"],
            desc: "The 'On-Demand' economy is built on speed. We develop applications that allow users to request any service—from a ride to home repair—with just a tap. Our focus is on creating a hyper-responsive experience where the bridge between user need and service delivery is virtually invisible.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["Scalable Service", "Marketplace"],
            desc: "A great On-Demand app needs to handle thousands of concurrent requests. We build scalable backends that manage provider availability, dynamic surge pricing, and multi-layered service categories, ensuring your platform remains stable even during peak demand periods.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Advanced Provider", "Dashboards"],
            desc: "Your service providers are the heart of your business. We create powerful apps for them to manage orders, track earnings, and optimize their working hours. Integrated analytics help providers improve their service quality and increase their revenue.",
            img: businessImg,
            reverse: false,
        },
        {
            title: ["Safety and Trust", "Mechanisms"],
            desc: "Trust is the currency of On-Demand platforms. We implement robust verification systems, real-time background checks, SOS buttons, and transparent rating/review systems to ensure a safe and reliable environment for both users and providers.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Flow Strategy", description: "Mapping the ecosystem for users, providers, and admins.", image: discoveryImg },
        { title: "Dynamic UX", description: "Designing interfaces that respond instantly to real-time events.", image: designImg },
        { title: "Core Build", description: "Integrating maps, payments, and real-time socket connections.", image: iterationImg },
        { title: "Scale Audit", description: "Stress-testing the system for thousands of live transactions.", image: handoffImg }
    ];
    ...
    const industryData = [
        { title: "Ride-Hailing", desc: "Uber-style apps for cars, bikes, and logistics management.", img: img1 },
        { title: "Home Services", desc: "On-demand plumbing, cleaning, and electrical repair apps.", img: img2 },
        { title: "Delivery & Courier", desc: "Hyper-local delivery services with real-time parcel tracking.", img: img3 },
        { title: "Health on Demand", desc: "Instant doctor consultations and nursing care at home.", img: img4 },
        { title: "Beauty Services", desc: "On-demand salons and professional makeup artists at your door.", img: img5 },
        { title: "Car Services", desc: "Emergency roadside assistance and car wash on demand.", img: img6 },
        { title: "Tutor & Coaching", desc: "Instant access to experts for learning or professional help.", img: img7 },
        { title: "Erand Services", desc: "Personal assistant apps to handle daily tasks and errands.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-[1.2] md:leading-[1.4] lg:leading-[1.4]">On-Demand App Solutions</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                From rides to repairs, we build powerful on-demand platforms that connect supply and demand in real-time. Speed, scale, and stability—all in one app.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="On-Demand Solutions" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">On-Demand <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Developing hyper-local, real-time ecosystems that transform traditional services into digital experiences.</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="On-Demand Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">On-Demand Dev Lifecycle</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">We engineer complex marketplaces with a focus on real-time data integrity and user satisfaction.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Modern Solutions for Modern Demands</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">Don't just compete—dominate. Campaignsquat builds the technical foundation you need to scale your on-demand business and provide superior service.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="On-Demand Efficiency" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">On-Demand Verticals</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Specialized architectures for businesses that thrive on instant service delivery.</p>
                    </div>
