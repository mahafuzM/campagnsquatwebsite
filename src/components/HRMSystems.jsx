...
/**
 * HRM Systems Service Page
 * Exact replica of ERPSystems & BusinessAutomation structure.
 */
...
const HRMSystems = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Employee Database", desc: "Centralized storage for employee profiles, documents, and digital employment records.", img: researchIcon },
        { id: "02", title: "Payroll Management", desc: "Automated salary processing, tax deductions, and digital pay slip generation.", img: uxIcon },
        { id: "03", title: "Attendance & Leave", desc: "Real-time attendance tracking with biometric integration and leave approval workflows.", img: webIcon },
        { id: "04", title: "Performance Review", desc: "Setting KPIs and tracking employee growth through structured appraisal cycles.", img: auditIcon }
    ];

    const featureData = [
        {
            title: ["Empower Your People", "With Modern HR Tech"],
            desc: "Managing people shouldn't be a paperwork nightmare. Our HRM systems digitize the entire employee lifecycle—from onboarding to offboarding. By centralizing core HR functions, you allow your HR team to focus on talent development rather than manual data entry.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["Error-Free Automated", "Payroll Processing"],
            desc: "Say goodbye to manual spreadsheet calculations. Our payroll engine handles complex salary structures, bonuses, and statutory deductions automatically. It ensures that your team is paid accurately and on time, every single month, with complete transparency.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Seamless Attendance and", "Remote Work Tracking"],
            desc: 'Whether your team is in-office or working remotely, our integrated attendance module keeps track of everything. With GPS-based check-ins and biometric sync, you get real-time data on employee availability and productive hours.',
            img: businessImg,
            reverse: false,
        },
        {
            title: ["Secure Employee", "Self-Service Portal"],
            desc: "Reduce HR ticket volume by giving employees their own dashboard. Through the self-service portal, employees can apply for leaves, download pay slips, and update their personal information, fostering an environment of trust and independence.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Requirement", description: "Mapping your company policies and organizational structure.", image: discoveryImg },
        { title: "Customization", description: "Configuring salary heads, leave types, and department hierarchies.", image: designImg },
        { title: "Data Upload", description: "Safe migration of existing employee records and historical data.", image: iterationImg },
        { title: "Rollout", description: "Live implementation with staff training and portal access.", image: handoffImg }
    ];

    const points = ["Automated Tax Compliance", "Biometric Integration", "Mobile App Access", "Custom Approval Flows", "Real-time HR Analytics"];

    const industryData = [
        { title: "Corporate Offices", desc: "Managing large teams with complex department hierarchies.", img: img1 },
        { title: "Retail Chains", desc: "Tracking shifts and attendance for multi-location store staff.", img: img2 },
        { title: "Healthcare", desc: "Roster management for doctors and staff in multi-specialty hospitals.", img: img3 },
        { title: "Tech Startups", desc: "Managing remote teams and performance-based growth plans.", img: img4 },
        { title: "Manufacturing", desc: "Tracking factory shifts, overtime, and labor compliance.", img: img5 },
        { title: "Educational Inst.", desc: "Managing faculty records and non-teaching staff payroll.", img: img6 },
        { title: "Hospitality", desc: "Managing seasonal staff and split-shift attendance records.", img: img7 },
        { title: "BPO/Call Centers", desc: "Tracking high-volume staff shifts and productivity metrics.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            ...
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                Simplify people management. Our custom HRM systems automate payroll, attendance, and employee performance to help you build a better workplace.
                            </p>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">HRM <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Transform your HR operations into a strategic business asset.</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="HRM Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Implementation Roadmap</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">From policy mapping to live rollout, we ensure a seamless digital HR transformation.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Modern HR Solutions for High-Performance Teams</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">We deliver secure and automated HRM solutions tailored to solve complex workforce management bottlenecks.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="HRM Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        ...
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Custom HRM architectures optimized for diverse sectors across the globe.</p>
                    </div>
