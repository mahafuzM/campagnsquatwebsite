...
const ECommerceApps = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Custom Storefront", desc: "Designing unique, high-converting shopping interfaces tailored to your brand's specific identity.", img: researchIcon },
        { id: "02", title: "Secure Checkout", desc: "Implementing multi-layered security for smooth, fraud-resistant payment processing and transactions.", img: uxIcon },
        { id: "03", title: "Inventory Sync", desc: "Real-time synchronization across app, web, and physical stores to ensure accurate stock levels.", img: webIcon },
        { id: "04", title: "Personalization", desc: "Using AI-driven recommendations to show users products they are most likely to purchase.", img: auditIcon }
    ];

    const featureData = [
        {
            title: ["Seamless Shopping", "Experience"],
            desc: "In E-commerce, every second counts. We build apps that load instantly and provide a friction-free path from product discovery to final checkout. Our focus is on intuitive navigation, fast search filters, and a high-speed interface that keeps customers engaged and reduces cart abandonment rates significantly.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["Integrated Payment", "Gateways"],
            desc: "We integrate all major payment methods, including credit cards, digital wallets (Apple Pay, Google Pay), and local payment solutions. Our checkout systems are designed to be mobile-first, ensuring that entering payment details is as quick and secure as possible for your customers, regardless of their location.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Robust Merchant", "Control Center"],
            desc: "Managing a store should be easy. Our E-commerce apps come with powerful administrative dashboards that let you track orders, manage customers, and update product listings on the go. Get real-time analytics on sales performance and user behavior to make data-driven decisions for your business.",
            img: businessImg,
            reverse: false,
        },
        {
            title: ["Push Notifications &", "User Retention"],
            desc: "Bring customers back with smart marketing tools. We implement advanced push notification systems for abandoned cart reminders, flash sale alerts, and personalized offers. By analyzing user shopping patterns, we help you send the right message at the right time to maximize your Customer Lifetime Value (CLV).",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Discovery", description: "Analyzing your product niche and defining the ideal customer journey.", image: discoveryImg },
        { title: "Conversion Design", description: "Creating UI/UX focused on turning visitors into loyal paying customers.", image: designImg },
        { title: "Secure Dev", description: "Building a scalable, secure backend with seamless API integrations.", image: iterationImg },
        { title: "Launch & Scale", description: "Deploying the app and monitoring performance for continuous growth.", image: handoffImg }
    ];

    const points = ["Omni-channel Integration", "One-Click Checkout", "Advanced Analytics", "SEO & Marketing Ready", "Scalable Cloud Hosting"];

    const industryData = [
        { title: "Fashion & Retail", desc: "High-end visual stores with virtual try-on and size guides.", img: img1 },
        { title: "Grocery Apps", desc: "Real-time inventory tracking and scheduled delivery slots.", img: img2 },
        { title: "Electronics", desc: "Detailed product specs and high-security transaction portals.", img: img3 },
        { title: "Beauty & Health", desc: "Subscription models and personalized product routines.", img: img4 },
        { title: "Marketplace", desc: "Multi-vendor platforms with complex commission systems.", img: img5 },
        { title: "Home Decor", desc: "AR-integrated shopping to visualize furniture in real spaces.", img: img6 },
        { title: "B2B Commerce", desc: "Bulk ordering, custom pricing, and wholesale management.", img: img7 },
        { title: "Food Delivery", desc: "Hyper-local ordering with live GPS tracking for customers.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-[1.2] md:leading-[1.4] lg:leading-[1.4]">E-commerce App Solutions</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                Turn your business into a 24/7 selling machine. We build scalable, secure, and high-converting mobile stores that customers love.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="E-commerce App Development" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Commerce <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Empowering brands with cutting-edge mobile commerce technology and retail strategies.</p>
                    </div>
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">E-commerce Roadmap</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">From wireframes to a fully functioning marketplace, we handle every step of your digital retail journey.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Build an App That Drives Serious Sales</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">Don't just launch a store; launch an experience. We combine psychological triggers with top-tier technology to help you dominate the mobile market.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="E-commerce Success" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Vertical E-commerce Solutions</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Custom features designed for specific niches to solve unique retail challenges.</p>
                    </div>
