...
const AndroidApps = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Native Android Dev", desc: "Expertly crafting high-performance apps using Kotlin and Java for the best Android experience.", img: researchIcon },
        { id: "02", title: "Play Store Optimization", desc: "Optimizing your app for the Google Play Store to increase visibility and user downloads.", img: uxIcon },
        { id: "03", title: "Material Design", desc: "Implementing Google's Material Design guidelines for a modern and intuitive Android UI.", img: webIcon },
        { id: "04", title: "Device Compatibility", desc: "Ensuring your app works perfectly across thousands of different Android device models.", img: auditIcon }
    ];

    const featureData = [
        {
            title: ["Optimized for the", "Android Ecosystem"],
            desc: "Android powers billions of devices worldwide. We build applications that take full advantage of the Android operating system, ensuring deep integration with Google Services, notifications, and hardware features. Our apps are built to be responsive, resource-efficient, and capable of running smoothly on everything from entry-level phones to high-end flagship devices.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["Hardware-Level", "Feature Integration"],
            desc: "From camera and GPS to biometrics and NFC, we specialize in building apps that interact directly with the device hardware. Whether you need a high-precision location service or a secure fingerprint authentication system, our development team ensures that the hardware components are utilized to their full potential while maintaining optimal battery life.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Robust Security &", "Play Protect Compliance"],
            desc: "Security is paramount for Android users. We follow Google's best practices for app security, implementing encrypted storage, secure networking (HTTPS), and ProGuard for code obfuscation. Every app we build is designed to pass Google Play Protect's rigorous security scans, ensuring your users feel safe and your business data remains protected.",
            img: businessImg,
            reverse: false,
        },
        {
            title: ["Scalable Architecture", "with Jetpack Tools"],
            desc: "We utilize modern Android development tools like Jetpack Compose and Hilt to create clean, modular codebases. This architecture makes it easy to update your app with new features as your business evolves. By following the MVVM (Model-View-ViewModel) pattern, we ensure that the app is easy to maintain, test, and scale for millions of users.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Analysis", description: "Defining features and target Android OS versions for your app.", image: discoveryImg },
        { title: "UI/UX Design", description: "Designing Material UI that resonates with Android users.", image: designImg },
        { title: "Development", description: "Coding the core functionality using Kotlin or Java.", image: iterationImg },
        { title: "Publishing", description: "Handling the complete Google Play Store submission process.", image: handoffImg }
    ];
    ...
    const industryData = [
        { title: "E-wallet", desc: "Secure Android-based digital payment and NFC solutions.", img: img1 },
        { title: "Marketplace", desc: "Scalable shopping apps for the diverse Android market.", img: img2 },
        { title: "Healthcare", desc: "Medical monitoring apps integrated with wearable devices.", img: img3 },
        { title: "Learning", desc: "Educational apps with offline mode and local storage.", img: img4 },
        { title: "Enterprise", desc: "Custom Android tools for field workers and office management.", img: img5 },
        { title: "Property", desc: "Real estate apps with integrated Google Maps and AR.", img: img6 },
        { title: "Logistics", desc: "Real-time delivery tracking with background location services.", img: img7 },
        { title: "Food Tech", desc: "Interactive food ordering apps with cloud messaging alerts.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-[1.2] md:leading-[1.4] lg:leading-[1.4]">Android App Development</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                Reach billions of users with powerful, native Android applications. We build feature-rich, high-performance apps tailored for the global Android market.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="Android Development" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Android <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Developing high-impact Android solutions that deliver seamless performance on every device.</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="Android Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Android Development Lifecycle</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">From initial concept to Google Play Store launch, we ensure a smooth and efficient development journey.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Why Choose Us for Android Development?</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">We don't just build apps; we create digital experiences that win the hearts of Android users globally.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="Android Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Android Solutions by Industry</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Custom-tailored Android applications designed to solve specific industry problems.</p>
                    </div>
