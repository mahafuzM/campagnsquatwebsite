...
import hiFiImg from "../assets/images/67bd99cca298f17199f21ee2_ux-audit.avif";
import motionDevImg from "../assets/images/67bd99cd9074293ebd3da898_visual-design.avif";
import usabilityImg from "../assets/images/67bd99cd0ac28e0c052e54d2_ui-ux-design.avif";
import devReadyImg from "../assets/images/67bd99cb048a34d913e1f6da_wireframing-and-prototyping.avif";
...
const InteractivePrototype = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Clickable Prototypes", desc: "Building high-fidelity, interactive demos that simulate real product behavior.", img: clickIcon },
        { id: "02", title: "Advanced Motion", desc: "Adding fluid animations and transitions to create a premium, polished feel.", img: motionIcon },
        { id: "03", title: "Developer Handoff", desc: "Providing clean specs and documentation to bridge the gap with developers.", img: handoffIcon },
        { id: "04", title: "Live Feedback Loops", desc: "Facilitating real-time testing and reviews to refine interactions quickly.", img: feedbackIcon }
    ];

    const featureData = [
        {
            title: ["Simulating Reality Before", "Writing Code"],
            desc: "Static designs only tell half the story. Our high-fidelity interactive prototypes bring your vision to life, allowing you to click, scroll, and experience the product before a single line of code is written. This 'tangible' experience is crucial for internal alignment, investor pitches, and early-stage marketing. By simulating complex interactions, we ensure that the logic holds up in practice, saving you months of development rework and thousands in technical costs.",
            img: hiFiImg,
            reverse: false,
        },
        {
            title: ["Purposeful Motion for", "Seamless Navigation"],
            desc: "Motion design is more than just 'decoration'; it's a vital part of the user experience. We use smart animations to guide the user's eye, explain the spatial relationship between elements, and provide instant visual feedback. Whether it's a subtle page transition or a complex micro-interaction, our motion work makes your digital product feel responsive, modern, and high-end, significantly increasing the perceived value and quality of your brand.",
            img: motionDevImg,
            reverse: true,
        },
        {
            title: ["Validation Through", "Interactive Testing"],
            desc: "We use interactive prototypes to run real-world usability tests. By observing users interact with a live-feel demo, we can identify friction points that static wireframes might miss. This data-driven approach allows us to optimize call-to-action placements, refine navigation flows, and perfect the onboarding experience based on actual human behavior. We iterate until the prototype feels intuitive and flawless, ensuring maximum conversion upon launch.",
            img: usabilityImg,
            reverse: false,
        },
        {
            title: ["Bridging the Gap Between", "Design and Code"],
            desc: "A great prototype is only successful if it can be built. Our prototypes are created with developers in mind, using organized layers, reusable components, and documented animation specs. We provide detailed handoff kits that include CSS properties, transition timings, and asset exports. This ensures that the final product looks and feels exactly like the approved prototype, eliminating the common 'lost in translation' issues between design and development teams.",
            img: devReadyImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Flow Mapping", description: "Connecting screens to define the interactive logic and user paths.", image: discoveryImg },
        { title: "Interactions", description: "Adding triggers, transitions, and animations to the UI components.", image: designImg },
        { title: "Testing", description: "Sharing the prototype with users to collect actionable feedback.", image: iterationImg },
        { title: "Handoff", description: "Preparing the technical specs for a seamless developer integration.", image: handoffImg }
    ];
    ...
    const industryData = [
        { title: "FinTech Demos", desc: "Testing complex transaction flows with realistic prototypes.", img: img1 },
        { title: "E-comm Checkout", desc: "Refining high-stakes shopping carts through interactive tests.", img: img2 },
        { title: "Health Monitoring", desc: "Simulating real-time data visualization for medical apps.", img: img3 },
        { title: "Learning Flows", desc: "Interactive course navigation and progress tracking demos.", img: img4 },
        { title: "SaaS Dashboards", desc: "Testing dynamic data manipulation and sidebar navigation.", img: img5 },
        { title: "Real Estate Tours", desc: "Interactive property exploration and filtering prototypes.", img: img6 },
        { title: "Travel Planners", desc: "Simulating multi-destination booking and itinerary flows.", img: img7 },
        { title: "Food Ordering", desc: "Testing the speed and efficiency of food delivery apps.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-tight">Interactive Prototype</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                We transform static screens into clickable, high-fidelity experiences that feel real, allowing you to validate ideas and secure buy-in before development starts.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="Prototype Visuals" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Interaction <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">From micro-interactions to complex user flows, we make design move.</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="Prototype Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Our Prototyping Workflow</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">We follow a rigorous process to ensure every transition is smooth and every interaction serves a purpose.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Feel the Future of Your App Today</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">Our interactive prototypes provide the closest possible experience to the final product, helping you make informed decisions with confidence.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="Prototyping Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Interactive Use Cases</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">See how prototypes solve problems across different industries.</p>
                    </div>
