...
const BookingApps = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Smart Scheduling", desc: "Advanced algorithms to prevent double-bookings and manage peak hours effectively.", img: researchIcon },
        { id: "02", title: "Real-time Availability", desc: "Instant sync technology to show live slots across all user devices and platforms.", img: uxIcon },
        { id: "03", title: "Multi-Currency Payments", desc: "Integrated gateways for global and local payments with automated invoice generation.", img: webIcon },
        { id: "04", title: "Automated Reminders", desc: "Smart push notifications and SMS alerts to reduce no-shows and increase revenue.", img: auditIcon }
    ];

    const featureData = [
        {
            title: ["Effortless Reservation", "Workflows"],
            desc: "The core of a booking app is simplicity. We design intuitive 3-step booking processes that eliminate confusion. Whether it's a hotel room, a doctor's appointment, or a flight, our UI ensures that users can find their desired slot and confirm it within seconds, providing a frictionless experience that keeps them coming back.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["Deep Calendar &", "Platform Integration"],
            desc: "Your app shouldn't exist in a vacuum. We integrate your booking system with Google Calendar, iCal, and Microsoft Outlook. This ensures that both the service provider and the customer stay updated on their schedules, reducing missed appointments and streamlining organizational efficiency.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Dynamic Pricing &", "Offer Management"],
            desc: "Maximize your profitability with flexible pricing models. We build systems that support dynamic pricing based on demand, early-bird discounts, and complex coupon logic. Easily manage seasonal variations and promotional campaigns from a centralized admin dashboard with detailed performance reports.",
            img: businessImg,
            reverse: false,
        },
        {
            title: ["User Profiles &", "Booking History"],
            desc: "Build loyalty through personalization. Our apps allow users to save their preferences, view past reservations, and re-book services with a single tap. Securely store user data to provide tailored recommendations, making every customer feel valued and understood by your brand.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Flow Mapping", description: "Designing the most efficient path from search to confirmation.", image: discoveryImg },
        { title: "Interface Design", description: "Creating a clean, accessible UI that simplifies complex data sets.", image: designImg },
        { title: "System Build", description: "Developing robust backends for real-time inventory and slot sync.", image: iterationImg },
        { title: "Quality Audit", description: "Rigorous testing of payment security and time-zone accuracy.", image: handoffImg }
    ];
    ...
    const industryData = [
        { title: "Travel & Tourism", desc: "Flight, hotel, and tour booking engines with live API updates.", img: img1 },
        { title: "Healthcare", desc: "Doctor appointments with patient portal and prescription history.", img: img2 },
        { title: "Beauty & Wellness", desc: "Spa and salon booking with staff management and reminders.", img: img3 },
        { title: "Event Management", desc: "Ticket sales and seat selection with QR code check-ins.", img: img4 },
        { title: "Service Rentals", desc: "Car and equipment rentals with duration-based dynamic pricing.", img: img5 },
        { title: "Real Estate Tours", desc: "Property viewing slots with integrated virtual tour links.", img: img6 },
        { title: "Sports & Gyms", desc: "Class scheduling, membership booking, and trainer slots.", img: img7 },
        { title: "Restaurant Res", desc: "Table bookings with pre-order options and floor-map management.", img: img8 },
    ];
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-[1.2] md:leading-[1.4] lg:leading-[1.4]">Smart Booking Applications</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                Simplify reservations and maximize efficiency. We build custom booking apps that streamline your operations and delight your customers.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="Booking App Solutions" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
           {/* Slider Section */}
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Booking <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Developing high-performance scheduling systems that keep your business running smoothly 24/7.</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="Booking App Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Booking Solution Roadmap</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">We follow a data-driven approach to build booking systems that are both reliable and scalable.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Revolutionize Your Scheduling Experience</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">Don't let manual errors slow you down. Campaignsquat builds booking platforms that automate your calendar and scale your business effortlessly.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="Booking System Success" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Niche Booking Solutions</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Tailored scheduling features for diverse industries to handle high-volume reservations.</p>
                    </div>
