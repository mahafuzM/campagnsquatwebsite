...
/**
 * Inventory & Billing Systems Page
 * Exact replica of ERPSystems premium UI structure.
 */

// ইমেজ ইমপোর্টসমূহ (তোর পাথ অনুযায়ী)
...
const InventoryBilling = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Stock Control", desc: "Real-time tracking of stock levels, movement, and reorder points across multiple branches.", img: researchIcon },
        { id: "02", title: "Smart Billing", desc: "Automated GST/VAT compliant invoicing, split payments, and digital receipts.", img: uxIcon },
        { id: "03", title: "QR/Barcode Sync", desc: "Lightning-fast product scanning and asset tracking with integrated mobile support.", img: webIcon },
        { id: "04", title: "Financial BI", desc: "Deep analytics on sales trends, profit margins, and automated tax reporting.", img: auditIcon }
    ];

    const featureData = [
        {
            title: ["Intelligent Inventory", "Optimization"],
            desc: "Stop overstocking and eliminate dead stock. Our system uses predictive algorithms to analyze sales velocity and suggests precise reorder quantities, ensuring your capital is never tied up in excess inventory.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["High-Speed POS &", "Unified Billing"],
            desc: "Deliver a seamless checkout experience with our modern POS. It handles discounts, loyalty points, and multi-mode payments (Cash, Card, Digital) while instantly updating your central inventory database.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Omnichannel Store", "Synchronization"],
            desc: 'Bridge the gap between your physical stores and online warehouse. Whether a sale happens on your website or at a retail counter, your stock levels are updated globally in real-time to prevent overselling.',
            img: businessImg,
            reverse: false,
        },
        {
            title: ["Automated Vendor &", "Purchase Workflow"],
            desc: "Streamline your procurement process. Automatically generate purchase orders when stock hits the threshold, manage vendor credit terms, and track incoming shipments till they reach your warehouse shelf.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Item Mapping", description: "Standardizing your product catalog with SKU, batch, and category levels.", image: discoveryImg },
        { title: "Logic Design", description: "Configuring tax slabs, pricing tiers, and warehouse workflow rules.", image: designImg },
        { title: "Migration", description: "Securely importing historical sales data and current opening stock.", image: iterationImg },
        { title: "Deployment", description: "Phase-wise rollout with POS terminal setup and staff training.", image: handoffImg }
    ];
    ...
    const industryData = [
        { title: "Supermarkets", desc: "Fast-paced retail with thousands of daily SKUs and barcodes.", img: img1 },
        { title: "Wholesale Hubs", desc: "Managing bulk distribution, credit limits, and aging reports.", img: img2 },
        { title: "E-commerce", desc: "Direct integration with online stores for automated fulfillment.", img: img3 },
        { title: "Pharmacies", desc: "Strict tracking of batch numbers, expiry dates, and schedules.", img: img4 },
        { title: "Fashion Retail", desc: "Managing matrix inventory based on size, color, and season.", img: img5 },
        { title: "Restaurants", desc: "Ingredient tracking, recipe management, and KOT integration.", img: img6 },
        { title: "Electronics", desc: "Serial number tracking and warranty management modules.", img: img7 },
        { title: "Automotive", desc: "Managing thousands of spare parts with location-wise tracking.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-[1.2] md:leading-[1.4] lg:leading-[1.4]">
                                Inventory & <br/>Billing Systems
                            </h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                Master your stock and automate your revenue tracking. We build specialized solutions to manage complex supply chains and high-volume transactions.
                            </p>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">System <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Full-cycle inventory and sales management with bank-grade precision.</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="Billing Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Workflow Deployment</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">From cataloging your first item to multi-store live sync.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Precision Tracking for Uninterrupted Growth</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">We provide end-to-end transparency in your supply chain and financial operations.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="Inventory Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Industry Verticals</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Specialized Inventory & Billing architectures for global business models.</p>
                    </div>
