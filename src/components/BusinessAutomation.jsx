 ...
 * This component is an exact replica of the UIUXDesign structure.
 * Every class, margin, and animation is preserved.
 * Line count maintained to be 258+.
 */

// ইমেজ ইমপোর্টসমূহ (ডেমো অনুযায়ী)
...
const BusinessAutomation = () => {
    ...
    const expertiseData = [
        { 
            ...
            desc: "Analyzing your current business processes to identify gaps and build highly optimized digital roadmaps for maximum efficiency.", 
            img: researchIcon 
        },
        { 
            id: "02", 
            title: "RPA Solutions", 
            desc: "Deploying Robotic Process Automation to handle repetitive back-office tasks, data entry, and form processing with zero errors.", 
            img: uxIcon 
        },
        { 
            id: "03", 
            title: "AI Integration", 
            desc: "Leveraging machine learning models to automate complex decision-making processes and predictive business analytics for scale.", 
            img: webIcon 
        },
        { 
            id: "04", 
            title: "Cloud Ops", 
            desc: "Automating your cloud infrastructure monitoring, data backups, and synchronization across multiple distributed systems.", 
            img: auditIcon 
        }
    ];
    ...
    const featureData = [
        {
            title: ["Empower Growth With", "Intelligent Workflows"],
            desc: "Manual workflows are the biggest killers of business productivity. Our automation engine takes over repetitive tasks, allowing your team to focus on strategic growth. We build smart, conditional logic into your existing systems that work 24/7 without fatigue. From lead generation to final billing, every single step is tracked, recorded, and executed with mathematical precision.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["Unified Dashboard", "For Total Control"],
            desc: "Automation doesn't mean losing control. We provide centralized monitoring systems where you can see every automated action in real-time. Whether it is tracking thousands of automated customer interactions or monitoring complex logistics chains, our visual dashboards give you the power to intervene whenever necessary while the system handles the heavy lifting.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Scalable Architecture", "Built For Longevity"],
            desc: 'We don’t just build scripts; we build robust automation architectures. As your business grows, your automation needs to grow too. Our systems are designed to be modular, meaning you can add new features, apps, or complex logic layers without breaking existing workflows. This ensures your investment today stays relevant for years to come.',
            img: businessImg,
            reverse: false,
        },
        {
            title: ["High Precision", "Error Mitigation"],
            desc: "Human error costs businesses millions. Our automated bridges act as the perfect audit trail. By eliminating manual data entry, we reduce operational errors by up to 99%. Every transaction and data point is verified against pre-set business rules before execution, ensuring that your data integrity remains flawless across all platforms and databases.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Audit & Analysis", description: "Deep diving into your current manual operations to find the highest impact areas for automation.", image: discoveryImg },
        { title: "Logic Architecture", description: "Designing the custom automation framework and scripting the triggers that will drive your business.", image: designImg },
        { title: "Testing & QA", description: "Rigorous testing of every automated path to ensure stability and handling under heavy loads.", image: iterationImg },
        { title: "Deployment", description: "Full-scale rollout of the automation engine with 24/7 monitoring to ensure peak performance.", image: handoffImg }
    ];

    const points = [
        "End-to-End Enterprise RPA", 
        "99.9% Operational Accuracy", 
        "Multi-Platform Sync Logic", 
        "Instant System Notification Triggers", 
        "Cost-Effective Scalability Plans"
    ];

    const industryData = [
        { title: "Banking", desc: "Automating loan processing and fraud detection systems with high-security encryption.", img: img1 },
        { title: "E-commerce", desc: "Dynamic inventory updates and automated customer journey emails based on behavior.", img: img2 },
        { title: "SaaS Ops", desc: "Automating user onboarding, subscription billing cycles, and customer support routing.", img: img3 },
        { title: "Healthcare", desc: "Streamlining patient scheduling and automated medical report generation with compliance.", img: img4 },
        { title: "Media & Ad", desc: "Automated ad-spend tracking and multi-platform performance reporting with AI insights.", img: img5 },
        { title: "Logistics", desc: "Real-time fleet tracking and automated warehouse management systems for visibility.", img: img6 },
        { title: "Education", desc: "Automated student enrollment, grading systems, and virtual classroom management.", img: img7 },
        { title: "HR & Payroll", desc: "Simplifying complex payroll calculations and automated tax filing for global teams.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white leading-tight">
                                Business Automation
                            </h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                Stop wasting time on repetitive tasks. We design and deploy intelligent automation systems that streamline your operations and maximize your profit.
                            </p>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Execution <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Unlocking the full potential of your business by converting manual chaos into automated precision.</p>
                    </div>
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Our Automation Lifecycle</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">From initial discovery to final optimization, we handle every aspect of your automation journey with focus on ROI.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Intelligent Automation for Global Scalability</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">We deliver high-impact automation solutions tailored to solve manual bottlenecks and turn your complex workflows into seamless experiences.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="Automation Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Global Impact Across Industries</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Tailored automation solutions across diverse sectors to solve complex operational problems.</p>
                    </div>
