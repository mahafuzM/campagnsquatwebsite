...
// ইমেজ ইমপোর্টসমূহ (তোর পাথ অনুযায়ী ঠিক রাখা হয়েছে)
...
const SoftwareDevelopment = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Custom Software", desc: "Tailor-made software solutions designed to solve specific business challenges and improve efficiency.", img: researchIcon },
        { id: "02", title: "Enterprise Systems", desc: "Large-scale software architecture that integrates complex business processes into one unified system.", img: uxIcon },
        { id: "03", title: "Cloud Integration", desc: "Seamlessly migrating and managing your software operations on secure, scalable cloud platforms.", img: webIcon },
        { id: "04", title: "Software Audit", desc: "Comprehensive analysis of existing codebases to improve security, performance, and scalability.", img: auditIcon }
    ];

    const featureData = [
        {
            title: ["Engineering Robust", "Digital Ecosystems"],
            desc: "Beyond simple tools, we build comprehensive software ecosystems that power your entire business. Our development philosophy focuses on creating backend architectures that are both flexible and powerful, ensuring your software can handle millions of data points without compromising on speed or security. Our engineering team prioritizes clean code to ensure long-term stability.",
            img: uxAuditImg,
            reverse: false,
        },
        {
            title: ["High-Security Coding", "Standards"],
            desc: "Data integrity is our top priority in software engineering. We implement end-to-end encryption, multi-factor authentication protocols, and follow the best industry practices to protect your intellectual property. Every line of code is written following international security standards (OWASP) to protect sensitive user data from modern cyber threats.",
            img: accessibilityImg,
            reverse: true,
        },
        {
            title: ["Scalability Built into", "Every Module"],
            desc: "We don't just build for today; we build for your future expansion. Using microservices architecture and containerization (Docker/Kubernetes), we ensure your software can scale rapidly. As your user base grows, your infrastructure will adapt automatically without expensive downtime, maintaining consistent high performance across the entire system.",
            img: businessImg,
            reverse: false,
        },
        {
            title: ["Legacy System", "Modernization"],
            desc: "Old software shouldn't hold your business back. We specialize in transforming outdated legacy systems into modern, high-performance applications. We migrate your data safely while introducing modern features, cloud-ready capabilities, and much faster processing speeds to give your business a competitive edge in the digital era.",
            img: scalableImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Analysis", description: "Deep dive into your business requirements and technical feasibility.", image: discoveryImg },
        { title: "Architecture", description: "Designing a robust technical structure and database schema.", image: designImg },
        { title: "Dev & QA", description: "Agile development paired with rigorous automated testing cycles.", image: iterationImg },
        { title: "Deployment", description: "Smooth rollout with continuous integration and real-time monitoring.", image: handoffImg }
    ];

    const points = ["Full-Cycle SDLC", "Agile Methodology", "Post-Launch Support", "Dedicated Tech Team", "Transparent Documentation"];

    const industryData = [
        { title: "Banking & Finance", desc: "Automating complex financial transactions with military-grade security.", img: img1 },
        { title: "Logistics", desc: "Smart supply chain management and real-time tracking software.", img: img2 },
        { title: "Healthcare", desc: "Patient management systems and secure medical data processing.", img: img3 },
        { title: "Education", desc: "Centralized campus management and interactive learning systems.", img: img4 },
        { title: "SaaS Platforms", desc: "Building multi-tenant software as a service for global markets.", img: img5 },
        { title: "Manufacturing", desc: "Optimizing production lines with intelligent industrial software.", img: img6 },
        { title: "Hospitality", desc: "Automated reservation and property management software solutions.", img: img7 },
        { title: "Retail Chains", desc: "Integrated POS and inventory software for large-scale retail.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white eading-[1.2] md:leading-[1.4] lg:leading-[1.4]">Software <br className="hidden lg:block"/>Development</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                Empower your business with custom-built software. We engineer high-performance, scalable systems that automate workflows and drive innovation.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="Software Development" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Software <span>Expertise</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Enterprise-grade solutions built with modern technology stacks.</p>
                    </div>
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Software Development Process</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">We follow a structured agile process to deliver high-quality software solutions on time and within budget.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Engineered for Performance and Reliability</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">At Campaignsquat, we combine technical excellence with business strategy to deliver software products that make an impact.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="Software Dev Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        ...
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Custom software solutions across different industries to solve unique challenges.</p>
                    </div>
