...
const CorporateSites = () => {
    ...
    const expertiseData = [
        { id: "01", title: "Brand Identity", desc: "Translating your corporate values into a high-end digital visual language.", img: architectureIcon },
        { id: "02", title: "Enterprise Security", desc: "Implementing multi-layer protection to safeguard sensitive corporate and client data.", img: blueprintIcon },
        { id: "03", title: "Compliance Ready", desc: "Ensuring your platform meets global standards like GDPR, HIPAA, or industry-specific regulations.", img: userFlowIcon },
        { id: "04", title: "Scalable Infrastructure", desc: "Building robust architectures designed to handle high-traffic corporate communications.", img: testingIcon }
    ];

    const featureData = [
        {
            title: ["Global Standards for", "Modern Enterprises"],
            desc: "A corporate website is the digital face of your organization. We focus on building authoritative platforms that command respect and build immediate trust with stakeholders. From seamless investor relations pages to complex multi-national site structures, we ensure your digital presence reflects your market leadership.",
            img: architectureImg,
            reverse: false,
        },
        {
            title: ["Data-Driven Content", "Architecture"],
            desc: "For large organizations, information hierarchy is critical. We design intuitive navigation systems that allow clients, partners, and prospective employees to find exactly what they need in seconds. Our UI/UX strategies reduce friction and enhance the perceived professionalism of your brand.",
            img: userJourneyImg,
            reverse: true,
        },
        {
            title: ["Advanced Search &", "Resource Hubs"],
            desc: "Corporations often have vast amounts of data and resources. We build custom-engineered search engines and document repositories that make accessing whitepapers, reports, and news archives effortless. We prioritize speed and accessibility across all corporate assets.",
            img: lowFidImg,
            reverse: false,
        },
        {
            title: ["Multilingual & Multi-Region", "Capabilities"],
            desc: "In a global economy, your site needs to speak every language. We develop sophisticated localization systems that serve region-specific content while maintaining a unified global brand identity. This allows your corporation to maintain consistency across different continents and cultures.",
            img: validationImg,
            reverse: true,
        },
    ];
    ...
    const processSteps = [
        { title: "Discovery", description: "In-depth analysis of stakeholder needs and corporate objectives.", image: discoveryImg },
        { title: "Governance", description: "Defining content workflows and security permission levels.", image: designImg },
        { title: "Development", description: "Building with enterprise-grade frameworks for maximum stability.", image: iterationImg },
        { title: "QA & Compliance", description: "Rigorous testing for security, accessibility, and cross-browser speed.", image: handoffImg }
    ];

    const points = ["Authority-Building Design", "High-Level Data Protection", "SEO for Institutional Keywords", "Seamless CRM Integrations", "Reliable 24/7 Uptime Support"];

    const industryData = [
        { title: "Financial Services", desc: "Secure and professional platforms for banks and investment firms.", img: img1 },
        { title: "Legal Institutions", desc: "Authoritative sites for global law firms and legal consultants.", img: img2 },
        { title: "Energy & Utilities", desc: "Information-rich portals for large-scale industrial providers.", img: img3 },
        { title: "Tech Corporations", desc: "High-performance showcases for enterprise software leaders.", img: img4 },
        { title: "Construction Giant", desc: "Portfolio-heavy sites highlighting massive infrastructure projects.", img: img5 },
        { title: "Healthcare Corps", desc: "Trust-centric platforms for hospital networks and biotech.", img: img6 },
        { title: "Logistics Hubs", desc: "Global supply chain visibility and corporate tracking sites.", img: img7 },
        { title: "Manufacturing", desc: "Scalable portals for global B2B manufacturing operations.", img: img8 },
    ];
        ...
        <main className="overflow-hidden font-poppins bg-[#02050a]">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full lg:w-1/2 flex flex-col space-y-6 md:space-y-8 text-center lg:text-left">
                            <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-white  leading-[1.2] md:leading-[1.4] lg:leading-[1.4]">Corporate Website Solutions</h1>
                            <p className="text-white text-[16px] md:text-[19px] max-w-[520px] mx-auto lg:mx-0 leading-relaxed font-normal">
                                We design and develop authoritative, secure, and scalable digital platforms that empower global organizations to lead.
                            </p>
                        ...
                        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                            ...
                            <img src={heroImage} alt="Corporate Design" className="relative z-10 w-full h-auto max-w-[550px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-transform duration-700 hover:scale-[1.02]" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#0A0A0A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 relative z-10 w-full text-center">
                    <div className="mb-20">
                        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Enterprise <span>Standard</span></h2>
                        <p className="text-white text-[18px] md:text-[20px] max-w-2xl mx-auto leading-relaxed font-medium">Digital engineering built for reliability, authority, and professional excellence.</p>
                    </div>
                            ...
                            <div key={index} className={`flex flex-col ${item.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between gap-12 md:gap-24`}>
                                ...
                                <div className="w-full md:w-1/2">
                                    <div className="relative group overflow-hidden rounded-[5px]">
                                        ...
                                        <img src={item.img} alt="Corporate Feature" className="relative z-10 w-full aspect-[16/10] object-cover border border-white/10 shadow-2xl transition-all duration-500 group-hover:scale-[1.03] rounded-[5px]" />
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <section className="w-full bg-[#02050A] py-24 md:py-32">
                <div className="max-w-[1445px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
                    <div className="flex flex-col items-center text-center mb-20 md:mb-28">
                        <h2 className="text-white text-[22px] md:text-[35px] lg:text-[45px] font-bold tracking-tight mb-6">Our Corporate Roadmap</h2>
                        <p className="text-white text-[16px] md:text-[18px] max-w-2xl font-light">A meticulous development sequence ensuring every stakeholder's vision is realized.</p>
                    </div>
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full relative">
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-32">
                        <div className="w-full lg:w-1/2 flex flex-col text-left order-2 lg:order-1 relative z-20">
                            <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold leading-[1.2] mb-8">Engineering Market Leadership</h2>
                            <p className="text-white text-[16px] md:text-[18px] leading-relaxed font-light mb-10 max-w-[580px]">We understand the complexities of corporate governance and branding. We provide the technical backbone that lets your organization communicate effectively with the world.</p>
                        ...
                        <div className="w-full lg:w-1/2 order-1 lg:order-2 relative z-10">
                            <div className="relative flex justify-center lg:justify-end">
                                <img src={sideImg} alt="Corporate Excellence" className="w-full h-auto max-h-[650px] object-contain rounded-[10px] border border-white/5 shadow-2xl" />
            ...
            <section className="py-24 md:py-36 mt-[-60px] md:mt-[-90px] relative z-10 overflow-hidden">
                ...
                <div className="max-w-[1445px] mx-auto px-6 md:px-12 lg:px-20 w-full">
                    <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
                        <h2 className="text-white text-[32px] md:text-[40px] lg:text-[45px] font-bold mb-6">Built for Institutional Authority</h2>
                        <p className="text-white text-[16px] md:text-[18px] lg:text-[20px] font-light">Industry-standard engineering for the world's most demanding sectors.</p>
                    </div>
